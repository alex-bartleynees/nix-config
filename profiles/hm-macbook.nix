{ pkgs, ... }: {
  ...
  home.file = {
    ".config/aerospace/aerospace.toml".text = ''
      #after-startup-command = ['exec-and-forget ~/.config/sketchybar/start-sketchybar.sh']
      # Notify Sketchybar about workspace change
      #exec-on-workspace-change = [
      #    '/etc/profiles/per-user/alexbartleynees/bin/zsh',
      #    '-c',
      ...
      #[exec.env-vars]
      #PATH = '/etc/profiles/per-user/alexbartleynees/bin/aerospace'
    '';
  };
}
